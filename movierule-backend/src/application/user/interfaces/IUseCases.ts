...
export interface IUseCases {
  ...
  getMovieDetailsByIdUseCase:(dependencies:IDependencies )=>IGetMovieDetails;
  toggleWatchlistUseCase:(dependencies:IDependencies )=>IToggleWatchlistUseCase;
  getWatchlistUseCase:(dependencies:IDependencies )=>IGetWatchlistUseCase;
}
