...
import { getCurrentTheaterController } from "./getCurrentTheater";
import { cancelBookingByTheaterController } from "./cancelBookingByTheater";
import { manageShowController } from "./manageShowByTheater";
...
export const theaterControllers=(dependencies:ITheaterDependencies)=>{
    return {
      ...
      theaterUpdateScreenLayout:
        theaterUpdateScreenLayoutController(dependencies),
      ...
      getCurrentTheater: getCurrentTheaterController,
      cancelBookingByTheater: cancelBookingByTheaterController,
      manageShowByTheater:manageShowController
    };
};