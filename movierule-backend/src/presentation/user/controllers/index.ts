...
import { getMovieByIdController } from "./getMoviesDetailsByID";
import { toggleWatchlistController } from "./toggleWatchlist";
import { getWatchlistController } from "./getWatchlist";
import { getCurrentUserController } from "./getCurrentUser";
import { lockSeatsController } from "./lockSeats";
import { unlockSeatsController } from "./unlockSeats";
import { getLockedSeatsController } from "./getLockedSeats";
...
export const controllers = (dependencies: IDependencies) => {
  return {
    ...
    getMoviesDetailsByID: getMovieByIdController(dependencies),
    toggleWatchlist: toggleWatchlistController(dependencies),
    getWatchlist: getWatchlistController(dependencies),
    getCurrentUser: getCurrentUserController(),
    lockSeats: lockSeatsController,
    unlockSeats: unlockSeatsController,
    getLockedSeats:getLockedSeatsController
  };
};
