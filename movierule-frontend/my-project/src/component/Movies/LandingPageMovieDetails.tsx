...
//   console.log(cast,"movie deatil inside deatail page");
...
//       const { scrollLeft, clientWidth, scrollWidth } = castContainerRef.current;
...
//           <h3 className="text-xl text-center mb-4 font-semibold text-white">
//             Casts
//           </h3>
