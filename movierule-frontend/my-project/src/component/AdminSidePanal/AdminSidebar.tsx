...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <div className="relative">
      {/* Combined Header */}
      <header className="flex items-center justify-between bg-[#141414] p-4 rounded-md text-white">
      ...
      {/* Admin Sidebar */}
      {isOpen && (
        <div className="fixed top-0 left-0 w-64 bg-[#1c1c1c] h-full transition-transform transform md:translate-x-0 z-50">
          ...
          <div className="absolute bottom-4 left-4">
            ...
            <button
              ...
              className="w-full text-left px-4 py-2 text-sm font-bold bg-[#E50914] hover:bg-red-700 text-white rounded"
            >
              Logout
            </button>
          </div>
