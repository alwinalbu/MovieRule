...
//   console.log(theaterOwner,"theater deatails inside verify otp");
...
function TheatreVerifyOtp() {
  ...
  const formik = useFormik<FormValuesOTP>({
    ...
    onSubmit: async (values) => {
      ...
      if (
        !theaterOwner?.email ||
        !theaterOwner?.username ||
        !theaterOwner?.password
      ) {
        Swal.fire({
          icon: "error",
          title: "Error",
      ...
      const theaterDetails: TheaterEntity = {
        ...
        username: theaterOwner.username,
        password: theaterOwner.password,
        confirmPassword: theaterOwner.confirmPassword,
        role: theaterOwner.role,
        status: theaterOwner.status,
        OwnerName: theaterOwner.OwnerName,
        address: theaterOwner.address,
        city: theaterOwner.city,
        state: theaterOwner.state,
        zipCode: theaterOwner.zipCode,
        phone: theaterOwner.phone,
        profilePicture: theaterOwner.profilePicture,
        aadhaarCard: theaterOwner.aadhaarCard,
        licenseDocument: theaterOwner.licenseDocument,
      };
